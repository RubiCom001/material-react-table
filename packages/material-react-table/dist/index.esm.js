...
const MRT_EditActionButtons = (_a) => {
    var { row, table, variant = 'icon', btnColors = ['primary', 'secondary'], details, attachments } = _a, rest = __rest(_a, ["row", "table", "variant", "btnColors", "details", "attachments"]);
    ...
    return (jsx(Box, { onClick: (e) => e.stopPropagation(), sx: (theme) => (Object.assign({ display: 'flex', gap: '0.75rem' }, parseFromValuesOrFunc(rest === null || rest === void 0 ? void 0 : rest.sx, theme))), children: variant === 'icon' ? (jsxs(Fragment, { children: [isEditInConflict && (jsxs(Fragment, { children: [jsx(Tooltip, { arrow: true, title: localization.merge, children: jsx(IconButton, { "aria-label": localization.merge, color: "info", onClick: handleMerge, children: jsx(MergeIcon, {}) }) }), jsx(Tooltip, { arrow: true, title: localization.dismiss, children: jsx(IconButton, { "aria-label": localization.dismiss, color: "info", onClick: handleDismiss, children: jsx(DismissIcon, {}) }) })] })), jsx(Tooltip, { title: !isEditInConflict ? localization.cancel : 'Accept Remote', children: jsx(IconButton, { "aria-label": localization.cancel, onClick: handleCancel, children: jsx(CancelIcon, {}) }) }), ((isCreating && onCreatingRowSave) ||
                    (isEditing && onEditingRowSave)) &&
                    !(isEditWithErrors || isEditInConflict) && (jsx(Tooltip, { title: localization.save, children: jsx(IconButton, { "aria-label": localization.save, color: "info", disabled: isSaving, onClick: handleSubmitRow, children: isSaving ? jsx(CircularProgress, { size: 18 }) : jsx(SaveIcon, {}) }) }))] })) : (jsxs(Fragment, { children: [isEditInConflict && (jsxs(Fragment, { children: [jsx(Button, { onClick: handleMerge, color: btnColors[0], variant: "contained", sx: { minWidth: '100px' }, children: localization.merge }), jsx(Button
                        //disabled={isSaving}
                        , { 
                            //disabled={isSaving}
                            onClick: handleDismiss, sx: { minWidth: '100px' }, variant: "contained", color: btnColors[0], children: localization.dismiss })] })), jsx(Button, { onClick: handleCancel, color: btnColors[0], sx: { minWidth: '100px' }, variant: "contained", children: !isEditInConflict ? localization.cancel : 'Accept Remote' }), !(isEditWithErrors || isEditInConflict) && (jsxs(Button, { disabled: isSaving, onClick: handleSubmitRow, sx: { minWidth: '100px' }, variant: "contained", color: btnColors[1], children: [isSaving && jsx(CircularProgress, { color: "inherit", size: 18 }), localization.save] }))] })) }));
};
...
const useMRT_TableInstance = (definedTableOptions) => {
    ...
    const [isEditInConflict, setIsEditInConflict] = useState((_q = initialState === null || initialState === void 0 ? void 0 : initialState.isEditInConflict) !== null && _q !== void 0 ? _q : false);
    const [isEditWithErrors, setIsEditWithErrors] = useState((_r = initialState === null || initialState === void 0 ? void 0 : initialState.isEditWithErrors) !== null && _r !== void 0 ? _r : false);
    const [pagination, onPaginationChange] = useState((_s = initialState === null || initialState === void 0 ? void 0 : initialState.pagination) !== null && _s !== void 0 ? _s : { pageIndex: 0, pageSize: 10 });
    const [showAlertBanner, setShowAlertBanner] = useState((_t = initialState === null || initialState === void 0 ? void 0 : initialState.showAlertBanner) !== null && _t !== void 0 ? _t : false);
    const [showColumnFilters, setShowColumnFilters] = useState((_u = initialState === null || initialState === void 0 ? void 0 : initialState.showColumnFilters) !== null && _u !== void 0 ? _u : false);
    ...
    table.setIsEditInConflict =
        (_9 = statefulTableOptions.onIsEditInConflict) !== null && _9 !== void 0 ? _9 : setIsEditInConflict;
    table.setIsEditWithErrors =
        (_10 = statefulTableOptions.onIsEditWithErrors) !== null && _10 !== void 0 ? _10 : setIsEditWithErrors;
    table.setShowAlertBanner =
        (_11 = statefulTableOptions.onShowAlertBannerChange) !== null && _11 !== void 0 ? _11 : setShowAlertBanner;
    table.setShowColumnFilters =
        (_12 = statefulTableOptions.onShowColumnFiltersChange) !== null && _12 !== void 0 ? _12 : setShowColumnFilters;
...
const MRT_EditCellTextField = (_a) => {
    ...
    const [value, setValue] = useState(() => { var _a; return (_a = cell.getValue()) !== null && _a !== void 0 ? _a : ''; });
    ...
    return isDatePicker ? (jsx(DatePicker, Object.assign({ displayWeekNumber: true, showDaysOutsideCurrentMonth: true, openTo: "year", views: ['year', 'month', 'day'], 
        //onChange={handleDateChange}
        ...
        } }), columnDef.accessorKey)) : (jsx(TextField, Object.assign({ disabled: parseFromValuesOrFunc(columnDef.enableEditing, row) === false, fullWidth: true, inputRef: (inputRef) => {
            if (inputRef) {
