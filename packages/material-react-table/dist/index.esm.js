...
const MRT_EditActionButtons = (_a) => {
    ...
    return (jsx(Box, { onClick: (e) => e.stopPropagation(), sx: (theme) => (Object.assign({ display: 'flex', gap: '0.75rem' }, parseFromValuesOrFunc(rest === null || rest === void 0 ? void 0 : rest.sx, theme))), children: variant === 'icon' ? (jsxs(Fragment, { children: [isEditInConflict &&
                    ...
                    (isEditing && onEditingRowSave)) && !(isEditWithErrors || isEditInConflict) && (jsx(Tooltip, { title: localization.save, children: jsx(IconButton, { "aria-label": localization.save, color: "info", disabled: isSaving, onClick: handleSubmitRow, children: isSaving ? jsx(CircularProgress, { size: 18 }) : jsx(SaveIcon, {}) }) }))] })) : (jsxs(Fragment, { children: [isEditInConflict &&
                    jsxs(Fragment, { children: [jsx(Button, { onClick: handleMerge, variant: "contained", sx: { minWidth: '100px' }, children: localization.merge }), jsx(Button
                            //disabled={isSaving}
                            , { 
                                //disabled={isSaving}
                                onClick: handleDismiss, sx: { minWidth: '100px' }, variant: "contained", children: localization.dismiss })] }), jsx(Button, { onClick: handleCancel, sx: { minWidth: '100px' }, children: !isEditInConflict ? localization.cancel : "Accept Remote" }), !(isEditWithErrors || isEditInConflict) &&
...
const MRT_EditCellTextField = (_a) => {
    ...
    return (isDatePicker ? (jsx(DatePicker, Object.assign({ displayWeekNumber: true, showDaysOutsideCurrentMonth: true, openTo: 'year', views: ['year', 'month', 'day'], 
        ...
        jsx(TextField, Object.assign({ disabled: parseFromValuesOrFunc(columnDef.enableEditing, row) === false, fullWidth: true, inputRef: (inputRef) => {
                if (inputRef) {
